                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 mx-auto">
                                <div class="card shadow p-4 border-danger">
                                    <h3 class="text-center text-danger">Delete the user with id = ${id}</h3>
                                    <hr>
                                    ...
                                    <form:form method="post" modelAttribute="newUser"
                                        action="${pageContext.request.contextPath}/admin/user/delete/${id}"
                                        class="text-center">
                                        <input type="hidden" name="id" value="${id}">

                                        <button type="submit" class="btn btn-danger px-4">Confirm</button>
                                        <a href="${pageContext.request.contextPath}/admin/user"
                                            class="btn btn-secondary px-4">Huỷ</a>
